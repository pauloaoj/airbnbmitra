...
export const entities: Entity[] = [
  ...
  // === NORMALIZAÇÃO DE ENDEREÇOS ===
  {
    name: "País",
    tableName: "pais",
    color: "entity-location",
    glowClass: "entity-glow-location",
    description: "Países cadastrados na plataforma",
    attributes: [
      { name: "id", type: "UUID", isPrimaryKey: true, description: "Identificador único" },
      { name: "nome", type: "VARCHAR(100)", description: "Nome do país" },
      { name: "codigo_iso", type: "VARCHAR(3)", description: "Código ISO do país" },
    ],
  },
  {
    name: "Estado",
    ...
    color: "entity-location",
    glowClass: "entity-glow-location",
    description: "Estados/Províncias dos países",
    attributes: [
      { name: "id", type: "UUID", isPrimaryKey: true, description: "Identificador único" },
      { name: "pais_id", type: "UUID", isForeignKey: true, references: "pais.id", description: "ID do país" },
      { name: "nome", type: "VARCHAR(100)", description: "Nome do estado" },
      { name: "sigla", type: "VARCHAR(10)", nullable: true, description: "Sigla do estado" },
    ],
  },
  {
    name: "Cidade",
    ...
    color: "entity-location",
    glowClass: "entity-glow-location",
    description: "Cidades cadastradas para busca e filtros",
    attributes: [
      { name: "id", type: "UUID", isPrimaryKey: true, description: "Identificador único" },
      { name: "estado_id", type: "UUID", isForeignKey: true, references: "estado.id", description: "ID do estado" },
      { name: "nome", type: "VARCHAR(100)", description: "Nome da cidade" },
    ],
  },
  {
    name: "Propriedade",
    ...
    attributes: [
      ...
      { name: "cidade_id", type: "UUID", isForeignKey: true, references: "cidade.id", description: "ID da cidade (normalizado)" },
      ...
      { name: "endereco", type: "VARCHAR(255)", description: "Endereço (rua, número)" },
  ...
  {
    name: "Avaliação Propriedade",
    tableName: "avaliacao_propriedade",
    color: "entity-review",
    glowClass: "entity-glow-review",
    description: "Avaliações de hóspedes sobre propriedades",
    attributes: [
      { name: "id", type: "UUID", isPrimaryKey: true, description: "Identificador único" },
      { name: "reserva_id", type: "UUID", isForeignKey: true, references: "reserva.id", description: "ID da reserva" },
      { name: "hospede_id", type: "UUID", isForeignKey: true, references: "usuario.id", description: "ID do hóspede avaliador" },
      { name: "propriedade_id", type: "UUID", isForeignKey: true, references: "propriedade.id", description: "ID da propriedade avaliada" },
      { name: "nota_geral", type: "INTEGER", description: "Nota geral (1-5)" },
      { name: "nota_limpeza", type: "INTEGER", description: "Nota limpeza" },
      { name: "nota_comunicacao", type: "INTEGER", description: "Nota comunicação" },
      { name: "nota_checkin", type: "INTEGER", description: "Nota check-in" },
      { name: "nota_precisao", type: "INTEGER", description: "Nota precisão" },
      { name: "nota_localizacao", type: "INTEGER", description: "Nota localização" },
      { name: "nota_custo_beneficio", type: "INTEGER", description: "Nota custo-benefício" },
      { name: "comentario", type: "TEXT", description: "Comentário" },
      { name: "criado_em", type: "TIMESTAMP", description: "Data de criação" },
    ],
  },
  {
    name: "Avaliação Hóspede",
    tableName: "avaliacao_hospede",
    color: "entity-review",
    glowClass: "entity-glow-review",
    description: "Avaliações de anfitriões sobre hóspedes",
    attributes: [
      { name: "id", type: "UUID", isPrimaryKey: true, description: "Identificador único" },
      { name: "reserva_id", type: "UUID", isForeignKey: true, references: "reserva.id", description: "ID da reserva" },
      { name: "anfitriao_id", type: "UUID", isForeignKey: true, references: "usuario.id", description: "ID do anfitrião avaliador" },
      { name: "hospede_id", type: "UUID", isForeignKey: true, references: "usuario.id", description: "ID do hóspede avaliado" },
      { name: "nota_geral", type: "INTEGER", description: "Nota geral (1-5)" },
      { name: "nota_comunicacao", type: "INTEGER", description: "Nota comunicação" },
      { name: "nota_limpeza", type: "INTEGER", description: "Nota limpeza deixada" },
      { name: "nota_regras", type: "INTEGER", description: "Nota cumprimento de regras" },
      { name: "recomendaria", type: "BOOLEAN", description: "Recomendaria o hóspede?" },
      { name: "comentario", type: "TEXT", description: "Comentário" },
      { name: "criado_em", type: "TIMESTAMP", description: "Data de criação" },
    ],
  },
...
export const relationships: Relationship[] = [
  ...
  { from: "pais", to: "estado", fromCardinality: "1", toCardinality: "N", label: "contém" },
  { from: "estado", to: "cidade", fromCardinality: "1", toCardinality: "N", label: "contém" },
  { from: "cidade", to: "propriedade", fromCardinality: "1", toCardinality: "N", label: "localiza" },
  ...
  // Avaliações bidirecionais
  { from: "reserva", to: "avaliacao_propriedade", fromCardinality: "1", toCardinality: "1", label: "gera" },
  { from: "reserva", to: "avaliacao_hospede", fromCardinality: "1", toCardinality: "1", label: "gera" },
  { from: "usuario", to: "avaliacao_propriedade", fromCardinality: "1", toCardinality: "N", label: "escreve" },
  { from: "usuario", to: "avaliacao_hospede", fromCardinality: "1", toCardinality: "N", label: "escreve" },
  { from: "propriedade", to: "avaliacao_propriedade", fromCardinality: "1", toCardinality: "N", label: "recebe" },
  // Pagamento
